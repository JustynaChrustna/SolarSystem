...
public class SolarObject implements Serializable{
    ...
    public SolarObject(JSONObject jsonObject) throws JSONException {
        ...
        if(moons!=null){
        this.moons=getSolarObjectFronJsonArray(moons);
    }}
    ...
    public static SolarObject[] loadArrayFromJson(Context context, String type){
        try {
            ...
            return getSolarObjectFronJsonArray(jsonArray);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    @NonNull
    private static SolarObject[] getSolarObjectFronJsonArray(JSONArray jsonArray) throws JSONException {
